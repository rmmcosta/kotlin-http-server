...
fun main(args: Array<String>) {
    ...
    val port: Int = args.firstOrNull { it.contains(serverPortKey) }?.removePrefix(serverPortKey)?.toInt() ?: SERVER_PORT
    ...
    MyHttpServer(ServerSocket(port), defaultDir, RequestHandler(HttpRequestParser())).initServer()
}
